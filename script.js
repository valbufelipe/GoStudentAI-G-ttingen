...
Ich suche ein WG-Zimmer ab dem ${datum} mit einem Budget von ungefähr ${budget}. Ich würde mich als ${personality || "freundlich, zuverlässig und respektvoll"} beschreiben.
...
I am looking for a shared apartment room starting from ${datum}, with a budget of around ${budget}. I would describe myself as ${personality || "friendly, responsible, and respectful"}.
...
Ich suche ab dem ${datum} ein WG-Zimmer bis ca. ${budget}. Ich bin ${personality || "freundlich, zuverlässig und respektvoll"}.
...
I’m looking for a shared room from ${datum}, up to around ${budget}. I’m ${personality || "friendly, responsible, and respectful"}.
...
if (!response.ok || !result.text) {
  document.getElementById("resultado").innerText =
    result.error || "AI response error. Bitte versuche es nochmal.";
